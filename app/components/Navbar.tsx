    ...
    return (
        <motion.nav
            ...
            className={`fixed w-full overflow-hidden z-50 transition-all duration-300 ${
                scrolled ? 'py-4 bg-darker/95 backdrop-blur-sm shadow-lg' : 'py-6 bg-transparent'
            }`}
        >
            <div className="container mx-auto px-8">
                    ...
                    <div className="hidden md:flex items-center space-x-8">
                        {navLinks.map((link) => (
                            ...
                            >
                                {link}
                                <span
                                    className={`absolute -bottom-2 left-0 w-full h-0.5 bg-[#fe9800] transform origin-left scale-x-0 
                ...
                {isOpen && (
                    <motion.div
                        ...
                        className="md:hidden mt-4 bg-darker/95 backdrop-blur-sm rounded-lg p-4 shadow-lg"
                    >
